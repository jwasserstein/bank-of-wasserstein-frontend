...
const LoginForm = props => (
    <form className='LoginForm-form' onSubmit={props.onSubmit}>
        ...
        <input type='text' className='LoginForm-field' value={props.username} onChange={props.onChange} id='username' name='username' placeholder='Username' autoComplete='off' required />
