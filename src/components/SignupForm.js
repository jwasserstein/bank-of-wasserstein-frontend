...
const SignupForm = props => (
    <form className='SignupForm-form' onSubmit={props.onSubmit}>
        ...
        <input type='text' className='SignupForm-field' value={props.username} onChange={props.onChange} name='username' id='username' placeholder='Username' autoComplete='off' required />
